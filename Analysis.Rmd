...
queerp.vals= tibble(Question = questionKey$Question[c(1:19)],Values = p.vals)
AllQueerSig = filter(queerp.vals, Values < 0.05)

```
Queer Undergrad Students T Test
```{r}
...
ugQueerSig = filter(queerp.vals, Value < 0.05)
